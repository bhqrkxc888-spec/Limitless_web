# PERPLEXITY PORT GUIDE PROMPT

Copy and paste this prompt into Perplexity to gather port data. Replace `[PORT NAME]` and `[COUNTRY]` with the actual port.
...
```
Create a comprehensive cruise port guide for [PORT NAME], [COUNTRY] with the following information. Use British English spelling and factual tone. Do NOT include price symbols (£, €, $) or emojis.
...
- Languages spoken:
- Timezone:
- Port type (Home Port/Port of Call/Both):
- Is the port walkable to city centre? (Yes/No):
- Is tender required? (Yes/No):

3. ABOUT THE PORT
- Overview paragraph about the cruise port, its size and location
- Which cruise terminals exist and where they are
- What shuttle services are available
- How far is the walk from port to city centre

4. GETTING AROUND
- How passengers get from ship to city
- Public transport options (metro, buses, trams)
- Taxi availability and info
- Walking distances
- Hop-on hop-off bus information if available

5. TRANSPORT CONNECTIONS
Airport:
- Airport name and code
- Distance from cruise port
- Transport options (taxi, bus, train) with journey times

Trains:
- Main railway station name
- Where trains go to/from
- Local train hubs
...
For each provide:
- Name
- Type (Market/Restaurant/Tapas Bar/Food Hall/Cafe)
- Description (what they're known for)
- Location tip (e.g. "5 minute walk from cathedral")

9. LOCAL TIPS (6-8 practical tips)
Provide insider tips covering:
- Booking tickets in advance (which attractions need pre-booking)
- Safety and pickpockets (specific areas to watch)
- Timing and queues (best times to visit popular spots)
- Transport advice (what works best for cruise passengers)
- Money (cash vs card, tipping customs)
- Local customs (siesta times, dining hours, dress codes for churches)
- Things to avoid (tourist traps, overpriced areas)
- Quick wins (easy things visitors often miss)

10. WEATHER DATA
Provide for ALL 12 MONTHS in this exact format:

Jan: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Feb: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Mar: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Apr: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
May: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Jun: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Jul: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Aug: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Sep: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Oct: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Nov: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C
Dec: High °C, Low °C, Rain mm, Sunny days per month, Sea temp °C

Best time to visit:
- Overall best months and why
- Peak season (pros and cons)
- Quieter months (pros and cons)
- Recommendation for first-time cruise visitors
...
4. Is [PORT NAME] safe for tourists?
5. Is [PORT NAME] expensive?
...
- Cruise terminal names (list)
- Nearest airport name and distance
- Visa requirements (for UK passport holders)
- Emergency number
- Tipping custom (brief)
- Siesta/shop closing times if applicable

13. TIME REQUIRED ESTIMATES
Provide realistic time estimates for the main sights:
- [Attraction 1]: X to Y hours for a relaxed pace
- [Attraction 2]: X to Y hours for a relaxed pace
- [Attraction 3]: X to Y hours for a relaxed pace
- [Attraction 4]: X to Y hours for a relaxed pace

Then provide a summary: "For a standard cruise day of 8 to 10 hours ashore, [realistic itinerary suggestion]."

Format all data clearly with British English (centre not center, organised not organized). Use "to" not em-dashes (2 to 3 hours, not 2–3 hours). No price symbols or emojis.
```
...
```
Create a comprehensive cruise port guide for Alicante, Spain following the format above. Include 6 must-see attractions with duration, 3 tips each, highlights and good-for tags. Include 10 FAQ questions, weather data for all 12 months, transport connections, 4 food venues, and 6-8 local tips. Use British English, no price symbols, factual tone.
```

### For Atlantic Coast Ports:
```
Create a comprehensive cruise port guide for Vigo, Spain following the format above. Include Santiago de Compostela as the day trip option. Include 6 must-see attractions with duration, 3 tips each, highlights and good-for tags. Include 10 FAQ questions, weather data for all 12 months, transport connections, 4 food venues, and 6-8 local tips. Use British English, no price symbols, factual tone.
```

### For Atlantic Islands:
```
Create a comprehensive cruise port guide for Funchal, Madeira following the format above. Include 6 must-see attractions (gardens, wine, levadas) with duration, 3 tips each, highlights and good-for tags. Include 10 FAQ questions, weather data for all 12 months, transport connections, 4 food venues, and 6-8 local tips. Use British English, no price symbols, factual tone.
```

### For UK Ports:
```
Create a comprehensive cruise port guide for Dover, UK following the format above. Include Canterbury as the day trip option. Include 6 must-see attractions with duration, 3 tips each, highlights and good-for tags. Include 10 FAQ questions, weather data for all 12 months, transport connections, 4 food venues, and 6-8 local tips. Use British English, no price symbols, factual tone.
```
...
Use the enhanced prompt for these ports:

**Mediterranean:**
1. Alicante, Spain - Costa Blanca beaches
2. Palma de Mallorca, Spain - Cathedral and old town
3. Valencia, Spain - City of Arts and Sciences
4. Nice, France - Côte d'Azur glamour
5. Monaco - Grand Prix circuit
6. Dubrovnik, Croatia - Game of Thrones walls
7. Split, Croatia - Diocletian's Palace
8. Kotor, Montenegro - Fjord-like bay
9. Santorini, Greece - Caldera views
10. Mykonos, Greece - Windmills and beaches

**Atlantic Coast:**
1. Bilbao, Spain - Guggenheim museum
2. La Rochelle, France - Historic harbour
3. Bordeaux, France - Wine country

**Norwegian Fjords (Future batch):**
1. Bergen, Norway - Bryggen wharf
2. Geiranger, Norway - Fjord views
3. Flam, Norway - Railway
4. Stavanger, Norway - Old town
...
2. Paste it back in our chat
3. I'll format it into the correct JavaScript structure with all new fields
4. I'll add it to the ports.js file
5. Images can be uploaded via the admin panel later
