export const siteConfig = {
  ...
  financialProtection: {
    abta: {
      enabled: true,
      number: 'P7541', // Co-op Travel Services ABTA number
  ...
  footerLegalText: [
    'Limitless Cruises Ltd when selling travel arrangements is a trading name of Co-op Travel Services Ltd. Limitless Cruises Ltd is a Member of Co-operative Travel Consortium (ABTA P7541).',
