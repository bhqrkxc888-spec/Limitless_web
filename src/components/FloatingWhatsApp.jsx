 ...
 * A floating WhatsApp button that's always visible for quick contact
 * Includes an expandable tooltip with call-to-action
 */
function FloatingWhatsApp() {
  ...
  return (
    <div className="floating-whatsapp">
      {/* Tooltip */}
      <div 
        className={`whatsapp-tooltip ${isExpanded ? 'is-visible' : ''}`}
