...
function BookingTerms() {
  return (
    <main className="booking-terms-page">
      ...
      <div className="container">
        <article className="booking-terms-content">
          <div className="booking-terms-intro">
            <p>
              <strong>Limitless Cruises Ltd</strong> is a member of <strong>Holiday Elite (ABTA P7541)</strong>. All bookings made with Limitless Cruises are subject to the <strong>Holiday Elite Booking Terms and Conditions</strong> set out below. By booking with us you are entering into a contract governed by these terms. Payments for bookings are handled by Holiday Elite.
            </p>
          </div>
          
          <p className="booking-terms-notice">
            <em>THESE TERMS APPLY FOR NEW BOOKINGS FROM <time dateTime="2018-07-01">1 July 2018</time>. FOR EARLIER BOOKINGS THE TERMS PROVIDED AT THE TIME OF BOOKING WILL CONTINUE TO APPLY.</em>
          </p>

          <section>
            <p>
              Except where otherwise specified, we Holiday Elite act only as an agent or sub-agent in respect of all bookings we take and/or make on your behalf. These are the terms on which we will make a booking for your travel or holiday requirements. When making your booking we will arrange for you to enter into a contract with the supplier(s) (e.g. tour operator/airline/cruise company/accommodation company) named on your receipt(s). We can book you a package holiday with one company or we can book the services that make up your holiday with different principals or suppliers, in which case you will have separate contracts with each of them. As agent we accept no responsibility for the acts or omissions of the supplier(s) or for the services provided by them. The supplier's (s') Terms &amp; Conditions will apply to your booking and we advise you to read these carefully as they do contain important information about your booking. Please ask us for copies of these if you do not have them. We may organise our own packages as agent for the various travel service suppliers. In that case these Terms should be read in conjunction with our Package Holiday Booking Conditions and the Terms and Conditions of the travel service suppliers. Our Agency Terms are governed by English Law and the jurisdiction of the English Courts. You may however, choose the law and jurisdiction of Scotland or Northern Ireland if you live there and wish to do so. All travel arrangements which we provide or which are sold through us are not an offer by us to sell any travel arrangements, but an invitation to you to make an offer to the suppliers of the arrangements. We are free to accept that offer on behalf of those suppliers or to reject it.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We have taken out insolvency protection with ABTA – The Travel Association. You can contact ABTA at 30 Park Street, London, SE1 9EQ; <a href="mailto:claims@abta.co.uk">claims@abta.co.uk</a>; <a href="tel:+442037588779">0203 758 8779</a> if services are denied because of our insolvency.
            </p>
            <p>
              Note: This insolvency protection does not cover contracts with parties other than with us, which can be performed despite our insolvency. A copy of the Package Travel and Linked Travel Arrangements Regulations 2018 can be found at <a href="http://www.legislation.gov.uk/uksi/2018/634/contents/made" target="_blank" rel="noopener noreferrer">http://www.legislation.gov.uk/uksi/2018/634/contents/made</a>
            </p>
          </section>
